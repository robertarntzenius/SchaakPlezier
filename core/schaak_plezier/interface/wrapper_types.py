...
class Move:
    ...
    def __init__(self, *args) -> None:
        ...
        match n:
            case 1:
                return self.from_move(*args)
            case 10:
                return self.from_parts(*args)
            case _:
                raise ValueError(f"Invalid nr of arguments: {n}. {args}")
    ...
    def from_move(self, move: wrappers.Move):
    ...
    def __eq__(self, other):
        ...
        return (
            (self.fromSquare == other.fromSquare)
